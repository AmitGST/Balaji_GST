...
namespace GSTN.API.GSTR1
{
    ...
    public class B2BInv
    {
        ...
        [Required]
        [Display(Name = "Supplier Invoice Number.(max16)")]
        [RegularExpression("^[a-zA-Z0-9]+$")]
        ...
        //Max length 5--R- Regular B2B Invoices,  DE – Deemed Exports, SEWP – SEZ Exports with payment,
        //SEWOP – SEZ exports without payment
        [Required]
        [Display(Name = "Invoice Type")]
        public string inv_typ { get; set; }

        // D-Delete, A-Accept, R-Reject, P-Pending
        [Required]
