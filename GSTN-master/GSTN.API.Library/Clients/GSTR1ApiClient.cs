...
using GSTN.API.Library.Models.GSTR1;
...
namespace Integrated.API.GSTN
{
    ...
    public class GSTR1ApiClient : GSTNReturnsClient
    {
        ...
        //action_required=“Y|N“
        public GSTR1ApiClient(IGSTNAuthProvider provider, string gstin, string ret_period)
            : base(provider, "/taxpayerapi/v1.0/returns/gstr1", gstin, ret_period)
        {
        }
