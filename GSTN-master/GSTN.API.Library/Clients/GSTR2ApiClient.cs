...
using Integrated.API.GSTN.GSTR2;
namespace Integrated.API.GSTN
{
	...
	public class GSTR2ApiClient : GSTNReturnsClient
	{
		...
		//action_required=“Y|N“
		public GSTR2ApiClient(IGSTNAuthProvider provider, string gstin, string ret_period) : base(provider, "/taxpayerapi/v0.3/returns/gstr2", gstin,ret_period)
		{
		}
