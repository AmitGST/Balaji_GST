...
namespace Integrated.API.GSTN
{
    ...
    public class GSTR3BApiClient : GSTNReturnsClient
    {
        ...
        //action_required=“Y|N“
        public GSTR3BApiClient(IGSTNAuthProvider provider,string gstin, string ret_period) : base(provider, "/taxpayerapi/v0.2/returns/gstr3b",gstin,ret_period)
        {
        }
        ...
        public GSTNResult<SaveInfo> Save(GSTR3BTotal data)
        {
