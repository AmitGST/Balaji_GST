<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="BALAJI.GSP.APPLICATION.Admin.Dashboard" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-default">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                            <ajaxToolkit:PieChart ID="pieChartSpecialInvoiceDetail" runat="server" ChartHeight="300"
                                ChartWidth="450" ToolTip="Invoice" ChartTitle=""
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="sparkbar" data-color="#00a65a" data-height="20"><canvas width="34" height="20" style="display: inline-block; width: 50px; height: 40px; vertical-align: top;"></canvas></div>
                    </td>
                  </tr>
                  <tr>
