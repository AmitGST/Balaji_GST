<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeBehind="GSTR3.aspx.cs" Inherits="BALAJI.GSP.APPLICATION.User.ureturn.GSTR3" %>
    ...
    <div class="content">
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                <asp:ListView ID="lvInvoices" DataKeyNames="InvoiceID,AuditTrailID" runat="server">
                    <EmptyDataTemplate>
                        <table class="table">
                            <tr>
                    ...
                    <ItemTemplate>
                        <tr>
                           <%-- <td>
                            ...
                            <td>
                                <asp:CheckBox ID="chkSelect" Visible='<%#DataBinder.Eval(Container.DataItem,"InvoiceAction").ToString()=="0"?true:false %>' runat="server" />
                            </td>
                            <td><%#DataBinder.Eval(Container.DataItem,"GST_TRN_INVOICE.InvoiceNo")%></td>
                            <td><%#Common.InvoiceAuditTrailSatus(DataBinder.Eval(Container.DataItem,"AuditTrailStatus").ToString()) %></td>
                          
                            <td><%#Common.InvoiceAuditTrailAction(DataBinder.Eval(Container.DataItem,"InvoiceAction").ToString()) %></td>
                            ...
                            <td>
                                ...
                                &nbsp; 
                                 <asp:LinkButton ID="lkbEdit" runat="server" OnClick="lkb_Click" CommandArgument='<%# Eval("InvoiceID") %>' ToolTip="Edit"><i class="fa fa-edit text-green"></i></asp:LinkButton>
            ...
            <div class="box-footer">
                <div class="pagination pagination-sm no-margin pull-right">
                 ...
                 <asp:LinkButton ID="lkbImport" Visible="false" CommandName="Import" CssClass=" btn btn-primary" runat="server" OnClick="lkbImport_Click" ><i class="fa fa-cloud-download"></i> Import - 3</asp:LinkButton>
