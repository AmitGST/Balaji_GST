...
{
    public partial class uc_B2CL_GSTR1 : System.Web.UI.UserControl
    {
        ...
        protected void lkbSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var items in lv_B2CL.Items)
                {
                    ...
                    int RateId = Convert.ToInt32(lv_B2CL.DataKeys[items.DisplayIndex].Value);
